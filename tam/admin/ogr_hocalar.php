...
<div class="card">
  <a class='edit-button' href='ogr_hoca_ekle.php'>Hoca Ekle</a>
    <table>
        <tr><th>Sıra</th>
            <th>Hoca Adı</th>
            <th>Soyadı</th>
        ...
        try {
            ...
            $sorgu = $db->prepare("SELECT hoca_ad, hoca_soyad, hoca_tc, hoca_alani, hoca_sinifi, iletisim FROM hocalar");
            $sorgu->execute();
            $hocalar = $sorgu->fetchAll(PDO::FETCH_ASSOC);
            ...
            if ($hocalar) {
                ...
                foreach ($hocalar as $hoca) {
                    ...
                    echo "<tr class='ara'>";
                    echo "<td>" . $counter .  "</td>";
                    echo "<td class='ara2'>".$hoca['hoca_ad']."</td>";              
                    echo "<td class='ara2'>".$hoca['hoca_soyad']."</td>";
                    echo "<td class='ara2'>".$hoca['hoca_tc']."</td>";
                    echo "<td class='ara2'>".$hoca['hoca_alani']."</td>";
                    echo "<td class='ara2'>".$hoca['hoca_sinifi']."</td>";
                    echo "<td class='ara2'>".$hoca['iletisim']."</td>";

               

                    // Düzenleme butonu ekle
                    echo "<td><a class='edit-button' href='ogr_hoca_ekle.php?KKLEsdfsdg9852358kJKBDSJFKNSAD379jjbsfsdfmösdf9325235jkdfkjs3HSFSDGN93434923JKSKSFGKSF849584282jsfdbfsdfjdkjoerhk769nsgjsngkjsn3534539045kjnfdsdgnnsdf329845245948snfdksjdn=".$hoca['hoca_tc']."&ALSDdasd=934341&ad=".$hoca['hoca_ad']."&soyad=".$hoca['hoca_soyad']."&alan=".$hoca['hoca_alani']."&sinif=".$hoca['hoca_sinifi']."&iletisim=".$hoca['iletisim']."'>Düzenle</a></td>";
                    echo "</tr>";
                }
            } else {
